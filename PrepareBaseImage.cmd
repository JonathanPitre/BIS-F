...
REM 06.08.2014 MS: Suppressed message for Set-ExecutionPolicy remoteSigned
...
REM 16.12.2015 MS: Added CLI command 'DisableIPv6' to disable IPv6 completely
REM 07.01.2016 MS: Changed ExecutionPolicy from unrestricted to Bypass
REM 10.03.2016 MS: Added CLI Switch 'DisableConsoleCheck' to disable the check of the session type
REM 16.03.2016 MS: Added CLI command 'LogShare' to set Central LogShare
REM 17.03.2016 MS: Added CLI command 'TurboUpdate' to update Turbo.net Subscription on system startup
